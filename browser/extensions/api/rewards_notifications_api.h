...
class RewardsNotificationsDeleteNotificationFunction : public ExtensionFunction {
 public:
...
class RewardsNotificationsDeleteAllNotificationsFunction : public ExtensionFunction {
 public:
...
class RewardsNotificationsGetAllNotificationsFunction : public ExtensionFunction {
 public:
